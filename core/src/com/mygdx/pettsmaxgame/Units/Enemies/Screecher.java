package com.mygdx.pettsmaxgame.Units.Enemies;
...
import com.mygdx.pettsmaxgame.Items.Coin;
import com.mygdx.pettsmaxgame.Screens.Hud;
import com.mygdx.pettsmaxgame.Screens.PlayScreen;
import com.mygdx.pettsmaxgame.Units.Enemy;


import static com.mygdx.pettsmaxgame.ForestChopper.ENEMYWALLS_BIT;
import static com.mygdx.pettsmaxgame.ForestChopper.ENEMY_BIT;
import static com.mygdx.pettsmaxgame.ForestChopper.GROUND_BIT;

import static com.mygdx.pettsmaxgame.ForestChopper.OBJECT_BIT;
import static com.mygdx.pettsmaxgame.ForestChopper.PLAYERSWORD_BIT;
import static com.mygdx.pettsmaxgame.ForestChopper.PLAYER_BIT;
import static com.mygdx.pettsmaxgame.ForestChopper.PPM;
import static com.mygdx.pettsmaxgame.ForestChopper.WALL_BIT;
...
public class Screecher extends Enemy {
    ...
    public Screecher(PlayScreen screen, float x, float y) {
        ...
        for (int i = 0; i < 7; i++) {
            frames.add(new TextureRegion(new Texture(TEXTURE_ORKSPRITESHEET),i*oWsize,0,oWsize,oHsize));
        }
        walkAnimation = new Animation(0.2f,frames);
        frames.clear();
        for (int i = 0; i < 5; i++) {
            frames.add(new TextureRegion(new Texture(TEXTURE_ORKSPRITESHEET),i*50,0,50,35));
        }
        bloodSplatterAnimation = new Animation(0.4f,frames);
        frames.clear();

        for (int i = 0; i < 7; i++) {
            frames.add(new TextureRegion(new Texture(TEXTURE_ORKDIEINGSPRITESHEET),i*oWsize,0,oWsize,oHsize));
        }
        dieingAnimation = new Animation(0.2f,frames);
        frames.clear();


        hurtAnimation = new Animation(0.2f,new TextureRegion(new Texture(TEXTURE_ORKHURT)));
